...
def main(MypyBot):
    ...
    cur_date_time_txt = cur_date_time.strftime("%Y-%m-%d-%H-%M")

    l_flg_sent = queries_to_bd.get_flg_sent(cur_date_time_txt)
    ...
    if l_flg_sent == 0:
        ...
        if len(list_users_subscriptions) != 0:
            ...
            for row in list_users_subscriptions:
                ...
                elif str(subscription_id) == '2' and cur_date_time.hour == 22 and cur_date_time.minute == 00:
                ...
                elif str(subscription_id) == '3' and cur_date_time.hour == 22 and cur_date_time.minute == 00:
        ...
        queries_to_bd.upd_flg_sent(cur_date_time_txt)
